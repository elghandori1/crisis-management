...
- [Screenshots](#-screenshots--interface-gallery)
...
### 🏠 Main Dashboard - Live Emergency Cases
Real-time monitoring of incoming emergency cases with interactive map, severity badges, and live location tracking.

![Main Dashboard](./screenshots/01-main-dashboard.png)

### 👤 Victim Information Details
Comprehensive case detail view showing patient information, vital signs, symptoms, assigned hospital, and emergency responder status.

![Victim Info](./screenshots/02-victim-details.png)

### 🏥 Hospital Availability & Capacity
Hospital resource management overview showing bed availability, current cases, required services, and hospital readiness status.

![Hospital Availability](./screenshots/03-hospital-availability.png)

### 📊 Severity Distribution by Location
Analytics and statistical breakdown of case severity levels across different districts and incoming emergency hotspots.

![Severity Distribution](./screenshots/04-severity-distribution.png)

### 🎙️ Voice Triage - AI Emergency Call
Browser-based voice interview interface where patients can speak with the AI triage operator for instant emergency assessment.

![Voice Triage Call](./screenshots/05-voice-triage.png)
...
```bash
git clone https://github.com/elghandori1/emergency_ai_hackathon.git
cd emergency_ai_hackathon.git
```
